...
def main():
    ...
    if args.dataset == "osd":
        dataset_name = "osd-110k-smolRGPT"
    ...
    elif args.dataset == "warehouse":
        dataset_name = "warehouse-rgbd-smolRGPT"
    ...
    for _ in range(len(val_dataset)):
        ...
        with torch.no_grad():
            ...
            print("=" * 25)
            # print(f"Normalized answer: {gpt_extractor(client,model_output)}")
